  ...
  do
      ...
      do
          ...
          ./RankingEDAsCEC -i ./TSP_instance/"${Problem[$ell]}".tsp\
                            -o ./TSP_result/NO/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_NO_"$times".txt\
                            -s "$times"\
                            -t TSP\
                            -m NO -d C -v 0\
          ...
          ./RankingEDAsCEC -i ./TSP_instance/"${Problem[$ell]}".tsp\
                            -o ./TSP_result/NT5/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_NT5_"$times".txt\
                            -s "$times"\
                            -t TSP\
                            -m NT -d C -v 0\
                            -p "$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"\
