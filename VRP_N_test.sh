...
ProblemSizeArray=("67" "49" "35")
Problem=("A-n60-k9" "A-n45-k6" "A-n32-k5")
# ProblemSizeArray=("60")
  ...
  do
      ...
      do
          ...
          ./RankingEDAsCEC -i ./VRP_instance/"${Problem[$ell]}".vrp\
                            -o ./VRP_result/NO/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_NO_"$times".txt\
                            -s "$times"\
                            -t VRP\
                            -m NO -d C -v 0\
          ...
          ./RankingEDAsCEC -i ./VRP_instance/"${Problem[$ell]}".vrp\
                            -o ./VRP_result/NT5/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_NT5_"$times".txt\
                            -s "$times"\
                            -t VRP\
                            -m NT -d C -v 0\
                            -p "$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"\
