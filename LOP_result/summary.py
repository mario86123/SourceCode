...
problem_instance_lst = ["t65b11xx", "be75eec", "sgb75.01"]
ell_lst = [44, 50, 75]
# opt_lst = [395371, 264940, 6142644] # according to EHBSA paper
opt_lst = [395371, 264940, 6150000] # according to EHBSA paper
...
for ell_count in range(len(problem_instance_lst)):
    ...
    for pop_size_count in range(len(pop_size_lst)):
        ...
        print(f'{problem_instance_lst[ell_count]:8} |', end=" ")
