...
problem_instance_lst = ["100a", "100b"]
# ell_lst = [20, 50]
opt_lst = [-21043560, -1185996137] # according to EHBSA paper




pop_size_lst = [3, 5, 10, 50, 100, 300, 500, 1000, 2000, 4000, 8000, 16000, 32000, 64000]
...
for ell_count in range(len(problem_instance_lst)):
    ...
    for pop_size_count in range(len(pop_size_lst)):
        ...
        for model_count in range(len(model_lst)):
            ...
            and (pop_size_lst[pop_size_count] == 3  \
              ...
              or pop_size_lst[pop_size_count] == 1000)) or \
            ...
            and (pop_size_lst[pop_size_count] == 100  \
              ...
              or pop_size_lst[pop_size_count] == 2000)) or \
            ...
            and (pop_size_lst[pop_size_count] == 1000 \
              ...
              or pop_size_lst[pop_size_count] == 8000 \
              or pop_size_lst[pop_size_count] == 16000 \
              or pop_size_lst[pop_size_count] == 32000 \
              or pop_size_lst[pop_size_count] == 64000)):
