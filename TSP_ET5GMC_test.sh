  ...
  do
      ...
      do
          ...
          ./RankingEDAsCEC -i ./TSP_instance/"${Problem[$ell]}".tsp\
                            -o ./TSP_result/ET5/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_ET5_"$times".txt\
                            -s "$times"\
                            -t TSP\
                            -m ET -d C -v 0\
          ...
          ./RankingEDAsCEC -i ./TSP_instance/"${Problem[$ell]}".tsp\
                            -o ./TSP_result/GMC/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_GMC_"$times".txt\
                            -s "$times"\
                            -t TSP\
                            -m GM -d C -v 0\
                            -p "$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"\
