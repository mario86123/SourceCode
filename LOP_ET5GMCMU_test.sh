  ...
  do
      ...
      do
          ...
          ./RankingEDAsCEC -i ./LOP_instance/"${Problem[$ell]}"\
                            -o ./LOP_result/ET5/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_ET5_"$times".txt\
                            -s "$times"\
                            -t LOP\
                            -m ET -d C -v 0\
          ...
          ./RankingEDAsCEC -i ./LOP_instance/"${Problem[$ell]}"\
                            -o ./LOP_result/GMC/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_GMC_"$times".txt\
                            -s "$times"\
                            -t LOP\
                            -m GM -d C -v 0\
                            -p "$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"\
          ...
          ./RankingEDAsCEC -i ./LOP_instance/"${Problem[$ell]}"\
                            -o ./LOP_result/MU/"${Problem[$ell]}"_"$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"_MU_"$times".txt\
                            -s "$times"\
                            -t LOP\
                            -m M -d U -v 0\
                            -p "$((${PopulationSizeArray[$pop]} * ${ProblemSizeArray[$ell]}))"\
